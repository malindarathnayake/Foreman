...
const CHANGELOG: ChangelogEntry[] = [
  { version: "0.1.1", date: "2026-06-08", description: "Tool metadata release - activation descriptions now telegraph spec-man stale-plan re-evaluation, Atlas/Graphify code-surfacing, Plan Delta Ladder promotion boundaries, lighttask escalation, and optional LangGraph-style runtime-control triggers for branching multi-session workflows. Adds citation verification: optional-but-expected verbatim anchors on [OBSERVED]/[IMPLEMENTED] file:line evidence refs, a shared citation-verification protocol section included by spec-man and doc-man, and a deterministic verify_citations tool that resolves refs under a repo root and reports CONFIRMED/DRIFTED/MISSING/UNANCHORED per ref. Spec/doc completion gates on every claim-bearing ref being CONFIRMED or explicitly downgraded. Backward compatible: existing unanchored citations remain valid." },
