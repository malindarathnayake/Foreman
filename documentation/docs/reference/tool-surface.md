...
| `write_journal` | `init_session`, `declare_model`, `log_event`, `end_session` | Declared model/effort workflow rank; 15 anomaly-only event codes; 200 events per session |
